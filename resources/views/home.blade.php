          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="well-middle">
              <div class="single-well">
                ...
                <p>
                    पेट्रोलपंप खरेदी / विक्री , गैस एजेंसी खरेदी / विक्री तथा नया पेट्रोलपंप खुलवाने हेतु भुमी की जाँच करना तथा मार्गदर्शन करना यही हमारा एकमात्र मकसद है !
                    सभी कार्यो की फीस ली जाती है
                </p>
                {{-- <ul>
                  <li>
      ...
      <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="well-left">
                <div class="single-well">
                <h1><b>All Services In One Place</b></h1>
                </div>
              </div>
            </div>
            <!-- single-well end-->
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="well-middle">
                <div class="single-well">
                  <a href="#">
                    <h4 class="sec-head"> <i class="bi bi-star"></i> क्या आप पेट्रोल पंप हेतु भूमि की जांच करवाना चाहते हो​</h4>
                    <h4 class="sec-head"> <i class="bi bi-star"></i> क्या आप नए पेट्रोल पंप विषयक जानकारी चाहते हो​</h4>
                    <h4 class="sec-head"> <i class="bi bi-star"></i> क्या आप नए गैस एजेंसी विषयक जानकारी चाहते हो​</h4>
                    <h4 class="sec-head"> <i class="bi bi-star"></i> क्या आप NOC विशेष सहायता चाहते हो​</h4>
                    <h4 class="sec-head"> <i class="bi bi-star"></i> क्या आप Application भरवाना चाहते हो​</h4>
                    <h4 class="sec-head"> <a href="tel:+4733378901"><i class="bi bi-star"></i> अधिक जानने के लिए हमें WhatsApp करे​​</a></h4>
                  </a>
                  {{-- <p>
                      पेट्रोलपंप खरेदी / विक्री , गैस एजेंसी खरेदी / विक्री तथा नया पेट्रोलपंप खुलवाने हेतु भुमी की जाँच करना तथा मार्गदर्शन करना यही हमारा एकमात्र मकसद है !
                      सभी कार्यो की फीस ली जाती है
              ...
              <div class="awesome-img">
                ...
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="portfolio-lightbox" data-gallery="myGallery" href="{{ asset('img/portfolio/1.jpg')}}">
                      <h4>Business City</h4>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 portfolio-item filter-web">
            <div class="single-awesome-project">
              <div class="awesome-img">
                ...
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="portfolio-lightbox" data-gallery="myGallery" href="{{ asset('img/portfolio/2.jpg')}}">
                      <h4>Blue Sea</h4>
                      <span>Photosho</span>
                    </a>
                  </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 portfolio-item filter-card">
            <div class="single-awesome-project">
              <div class="awesome-img">
                ...
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="portfolio-lightbox" data-gallery="myGallery" href="{{ asset('img/portfolio/3.jpg')}}">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 portfolio-item filter-web">
            <div class="single-awesome-project">
              <div class="awesome-img">
                ...
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="portfolio-lightbox" data-gallery="myGallery" href="{{ asset('img/portfolio/4.jpg')}}">
                      <h4>Creative Team</h4>
                      <span>Web design</span>
                    </a>
                  </div>
            ...
            <div class="single-awesome-project">
              <div class="awesome-img">
                ...
                <div class="add-actions text-center text-center">
                  <div class="project-dec">
                    <a class="portfolio-lightbox" data-gallery="myGallery" href="{{ asset('img/portfolio/5.jpg')}}">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 portfolio-item filter-web">
            <div class="single-awesome-project">
              <div class="awesome-img">
                ...
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="portfolio-lightbox" data-gallery="myGallery" href="{{ asset('img/portfolio/6.jpg') }}">
                      <h4>Night Hill</h4>
                      <span>Photoshop</span>
                    </a>
                  </div>
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs=12">
            <div class="suscribe-text text-center">
              <h3>Welcome to our Petroleum  company</h3>
